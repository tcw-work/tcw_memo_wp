        ...
        <nav>
          <div class="nav_in">
            ...
            <div class="h_nav">
              <ul>
                ...
                <li class="nav_cat"><a href="">categories</a></li>
                <li class="nav_tag"><a href="">Tag</a></li>
                <li class="nav_window"><img src="src/img/common/search.png" alt=""></li>
                <li> 
                  <div class="h_nav_hov h_nav_window is_sp">
                    <input type="text" name="search" value="" placeholder="キーワードを入力"><span>
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="17px" height="17px">
                        <image x="0px" y="0px" width="17px" height="17px" xlink:href="data:img/png;base64,"></image>
                      </svg></span>
                  </div>
                </li>
              </ul>
          ...
          <div class="h_nav_inside">
            <div class="h_nav_hov h_nav_tag"> 
              <ul>
                <li> <a href="">#Tag01</a></li>
                <li> <a href="">#Tag02</a></li>
                <li> <a href="">#Tag03</a></li>
      ...
      <div class="main_content">
        <section class="new_block">
          ...
          <article class="card_02">
            <div class="small_card"><a class="card_link" href="article.html">
                <div class="small_card_left">
                  <object><a href="#"><img src="src/img/common/a_icon_html.png" alt=""></a></object>
                </div>
                <div class="small_card_right">
                  <div class="top">
                    <ul>
                      ...
                      <li class="l_cat">
                        <object><a href="#">Cat</a></object>
                      </li>
                      <li class="s_cat">
                        <object><a href="#">Cat02</a></object>
                      </li>
                      <li class="tag">
                        <object><a href="#">Tag</a></object>
                      </li>
                      <li class="tag">
                        <object><a href="#">Tag02</a></object>
                      </li>
                    </ul>
                  </div>
                  <div class="bottom">
                    <p>
                      <object>Bracketsを使ってSCSSをCMD経由でコンパイルする方法を解決</object>
                    </p>
                  </div>
                </div></a></div>
          </article>
          <article class="card_02">
            <div class="small_card"><a class="card_link" href="article.html"> 
                <div class="small_card_left">
                  <object><a href="#"><img src="src/img/common/a_icon_psd.png" alt=""></a></object>
                </div>
                <div class="small_card_right">
                  <div class="top">
                    <ul>
                  ...
                  <div class="bottom">
                    <p>
                      <object>Photoshopで選択範囲を切り取る際にマスクを作って作業しやすくする方法</object>
                    </p>
                  </div>
                </div></a></div>
          </article>
